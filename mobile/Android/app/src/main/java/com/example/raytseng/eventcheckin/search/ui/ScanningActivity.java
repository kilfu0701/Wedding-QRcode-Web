...
import com.example.raytseng.eventcheckin.search.camera.CameraPreview;
...
public class ScanningActivity extends ActionBarActivity {
        ...
        public void onPreviewFrame(byte[] data, Camera camera) {
            ...
            if (result != 0) {
                ...
                for (Symbol sym : syms) {
                    ...
                    // Start search guest on server
                    searchGuestOnServer(sym.getData());
    ...
    /**
     * send QRcode result to server for searching guest
     * */
    public void searchGuestOnServer(String qrCodeRes) {

        Log.i(TAG, "QRCode result: " + qrCodeRes);
